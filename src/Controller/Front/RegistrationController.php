...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager, AllowedDomainRepository $allowedDomainRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $allowedDomain = $allowedDomainRepository->findOneBy(['name' => explode('@', $user->getEmail())[1]]);

            if ($allowedDomain instanceof AllowedDomain) {
            ...
            $this->addFlash('success', 'Un email de vérification vous a été envoyé. Merci de cliquer sur le lien.');
